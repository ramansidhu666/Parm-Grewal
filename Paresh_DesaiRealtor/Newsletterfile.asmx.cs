    ...
    public class Newsletterfile : System.Web.Services.WebService
    {
        ...
        public string PrintNewsLetter(string NewsLetterId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    string FirstImage = dt.Rows[0]["image"].ToString();
                    string SecondImage = dt.Rows[0]["second_Image"].ToString();
                    string Template = "";
                    Template = "PrintHtmlFiles/FirstNewsletter.html";
        ...
        [System.Web.Services.WebMethod]
        public string UpdateGreetingDate(string NewsLetterId, string SelectedDate)
        {
            string html = "";
            string qry = "";
            if (NewsLetterId != null && NewsLetterId != "")
